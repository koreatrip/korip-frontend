  ...
  ({ onClear, ...props }, ref) => {
    ...
    return (
      <div className='relative w-full'>
        <input
          ref={inputRef}
          className='ring-outline-gray placeholder:text-sub-text-gray focus:ring-main-pink shadow-light w-full rounded-lg border-0 px-4 py-4 ring-1 outline-none ring-inset focus:ring-2 focus:ring-inset'
