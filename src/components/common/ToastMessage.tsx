...
const ToastMessage = ({
  ...
  return (
    ...
    >
      <div
        className={`${config.bgColor} ${config.borderColor} shadow-large relative flex max-w-[400px] min-w-[200px] items-center gap-3 rounded-xl border px-4 py-3 text-sm font-medium text-white backdrop-blur-sm`}
      >
        {/* 아이콘 */}
        ...
        {/* 진행 바 */}
        {/* <div className='absolute bottom-0 left-0 h-1 w-full overflow-hidden rounded-b-xl bg-white/30'>
          <div
